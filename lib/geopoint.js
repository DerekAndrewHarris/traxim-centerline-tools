...
console.log('[geopoint.js] Starting to load geopoint.js...');
...
console.log('[geopoint.js] GeoPoint class defined:', typeof GeoPoint);
if (typeof window !== 'undefined') {
    window.GeoPoint = GeoPoint;
    console.log('[geopoint.js] GeoPoint explicitly attached to window');
}
